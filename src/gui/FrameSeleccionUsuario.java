...
public class FrameSeleccionUsuario extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrameSeleccionUsuario
     */
    public FrameSeleccionUsuario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Usuario Administrador");
        ...
        jButton2.setText("Dueño escuderia");
        ...
        jButton3.setText("Director Mundial");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        FrameManager.getInstance().mostrarVentanaEscuderia(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameSeleccionUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrameSeleccionUsuario frame = new FrameSeleccionUsuario();
